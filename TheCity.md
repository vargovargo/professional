...
### The City is the place we spend most of our days and nights, it shapes our behavior, exposures, and interactions. ###

Behavior represents the interaction of the person and the environment.

This involves examining the city as the environment we inhabit and interact with on a daily basis: connections with ourselves.   The urban environment shapes our behaviors. The environment, and its impact on our behavior are largely responsible for our overall health, yet receive little attention and direct investment.  (*[environment and behavior account for more than 70% of health determinants but less than 10% of all health expenditures](http://www.nehi.net/writable/publication_files/file/boston_paradox_onepager_2008.pdf)*)
